...
//#define REALSPI   // miniBCS uses HW SPI
...
Adafruit_GFX(SHARPMEM_LCDWIDTH, SHARPMEM_LCDHEIGHT) {
  ...
  #define LCD_SPI_SPEED 14000000
  #define LCD_SPI_ORDER LSBFIRST
...
/**************************************************************************/
/*!
    @brief  Sends a single byte in real-SPI.
*/
/**************************************************************************/
...
#ifdef REALSPI
    SPI.beginTransaction(SPISettings(LCD_SPI_SPEED, LCD_SPI_ORDER, LCD_SPI_MODE));
#endif	
