...
int dutyCycle  = floor(pulseWidth / (1000 / sampleFreq) * 256); // duty cycle 256 equals to 100% duty cycle
  ...
  switch (pulseState) {
    case 0: // in this state, turn on the trigger pulse
      if ( trialOffset == false ) { // trial offset TTL
        analogWrite(20, dutyCycle); // use pin 20, duty cycle 77/256*100 = 30%
